...
password_confirm.send_keys("3681")
...
agree = driver.find_element(By.XPATH, '//*[@id="content"]/form/div/div/div/label/a')
# click on the agree checkbox
agree.click()

# find the continue button
continue_button = driver.find_element(By.XPATH, '//*[@id="content"]/form/div/div/text()')
